...
-- Criar GUI base se não existir
local NotifGui = CoreGui:FindFirstChild("RedzHubNotifications")

if not NotifGui then
    NotifGui = Instance.new("ScreenGui")
    NotifGui.Name = "RedzHubNotifications"
...
-- Função Notify estilo redzlib
function redzlib:Notify(options)
    ...
    Content.Size = UDim2.new(1, -10, 0, 35)
    ...
    -- Auto ajustar altura
    task.wait()
    local NeededSize = 35 + Content.TextBounds.Y + 10

    TweenService:Create(
        Notification,
        TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
        {Size = UDim2.new(1, 0, 0, NeededSize)}
    ):Play()
